...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PurificationRepository")
 */
class Purification
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Mineral", mappedBy="purifications")
     */
    private $minerals;
    ...
    public function removeMineral(Mineral $mineral): self
    {
        if ($this->minerals->contains($mineral)) {
            ...
            $mineral->removePurification($this);
        }
